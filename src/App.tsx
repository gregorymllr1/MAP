              ...
              <div>
                ...
                >
                  ...
                  <optgroup label="Vegetables">
                    {Object.entries(PRODUCE_DATA).filter(([_, v]) => v.category === 'vegetable').map(([k, _]) => <option key={k} value={k} className="text-slate-900 bg-white">{k}</option>)}
                  </optgroup>
                </select>
              </div>
            ...
            {report === null ? (
              ...
              <div className="space-y-6">
                ...
                <div className="relative rounded-[24px] border-2 border-emerald-500 bg-gradient-to-b from-white to-emerald-50/40 p-6 shadow-[0_10px_30px_rgba(16,185,129,0.35)]">
                  <div className="absolute right-5 top-4 rounded-full bg-emerald-600 px-4 py-1 text-[10px] font-black text-white md:text-sm">RECOMMENDED DESIGN</div>
